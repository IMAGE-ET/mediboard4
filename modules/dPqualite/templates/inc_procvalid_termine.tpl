{{* $Id: inc_procvalid_termine.tpl 12793 2011-07-29 15:58:25Z mytto $ *}}
...
<table class="form">
  ...
  <tr>
    <td colspan="2" class="button">
      <a href="#" onclick="popFile('{{$docGed->_class}}','{{$docGed->_id}}','CFile','{{$docGed->_lastactif->file_id}}')" title="{{tr}}CFile-msg-viewfile{{/tr}}">
