{{* $Id: vw_procencours.tpl 19036 2013-05-07 08:26:15Z flaviencrochard $ *}}

{{*
 * @package Mediboard
 * @subpackage dPqualite
 * @version $Revision: 19036 $
      ...
      <table class="form">
        ...
        {{elseif $docGed->etat==$docGed|const:'REDAC'}}
          ...
          <tr>
            ...
            <td>
              <a href="#" onclick="popFile('{{$docGed->_class}}','{{$docGed->_id}}','CFile','{{$docGed->_lastentry->file_id}}')" title="{{tr}}CFile-msg-viewfile{{/tr}}">
