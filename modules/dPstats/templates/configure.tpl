{{* $Id: configure.tpl 6230 2009-05-06 10:00:44Z phenxdesign $ *}}
  ...
  <tr>
    <td class="halfPane">
      <table class="form">
        ...
        <tr>
          <td>
            <input type="radio" name="intervalle" value="month" /><label for="intervalle_month" title="Prise en compte du dernier mois">Dernier mois</label>
          </td>
          <td>
            <input type="radio" name="intervalle" value="6month" /><label for="intervalle_6month" title="Prise en compte des 6 derniers mois">6 derniers mois</label>
          </td>
        </tr>
        <tr>
          <td>
            <input type="radio" name="intervalle" value="year" /><label for="intervalle_year" title="Prise en compte de la dernière année">Dernière année</label>
          </td>
          <td>
            <input type="radio" name="intervalle" value="none" checked="checked" /><label for="intervalle_none" title="Prise en compte sans intervalle">Pas d'intervalle</label>
          </td>
        </tr>
      </table>
    </td>
