{{* $Id: vw_bloc2.tpl 25739 2014-11-05 17:04:22Z armengaudmc $ *}}

{{*
 * @package Mediboard
 * @subpackage dPstats
 * @version $Revision: 25739 $
...
<table class="form">
  ...
  <tr>
    ...
    <td class="button" rowspan="4" style="width: 10%">
      <div class="small-info">Cliquer sur l'icone pour télécharger les données au format CSV.</div>
    </td>
