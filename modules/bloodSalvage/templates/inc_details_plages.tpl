{{* $Id: inc_details_plages.tpl 10842 2010-12-08 21:57:35Z MyttO $ *}}
...
<table class="form">
 ...
 <table class="tbl">
  ...
  {{include file="../../bloodSalvage/templates/inc_liste_operations.tpl" urgence=0 operations=$_plage->_ref_operations}}
  {{/if}}
  ...
  {{include file="../../bloodSalvage/templates/inc_liste_operations.tpl" urgence=0 operations=$_plage->_unordered_operations}}
  {{/if}}
</table>
{{/foreach}}
...
<table class="tbl">
  {{include file="../../bloodSalvage/templates/inc_liste_operations.tpl" urgence=1 operations=$salle->_ref_deplacees}}
</table>
{{/if}}
...
<table class="tbl">
  {{include file="../../bloodSalvage/templates/inc_liste_operations.tpl" urgence=1 operations=$salle->_ref_urgences}}
</table>
{{/if}}