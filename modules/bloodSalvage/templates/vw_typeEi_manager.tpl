{{* $Id: vw_typeEi_manager.tpl 24462 2014-08-19 07:53:20Z flaviencrochard $ *}}
          ...
          <tr>
            ...
            <td>
              ...
              <select name="_cat_evenement" onchange="viewItems(this.value);">
                ...
                <option value="{{$curr_evenement->ei_categorie_id}}" {{if $curr_evenement->ei_categorie_id == $firstdiv}}selected{{/if}}>
                  {{$curr_evenement->nom}}
                </option>
                {{/foreach}}
              </select>
          ...
          <tr>
            ...
            <td colspan="2">
              ...
              <table class="tbl" id="Items{{$curr_evenement->ei_categorie_id}}" {{if $curr_evenement->ei_categorie_id!=$firstdiv}}style="display:none;"{{/if}}>
                ...
                {{/if}}
                  <td class="text">
                    <input type="checkbox" name="{{$curr_item->_id}}" onclick="toggleCode(this.name, this.checked);" {{if $curr_item->checked}}checked{{/if}} />
                    <label for="{{$curr_item->ei_item_id}}" id="titleItem{{$curr_item->_id}}" title="{{$curr_item->nom}}">{{$curr_item->nom}}</label>
                  </td>
