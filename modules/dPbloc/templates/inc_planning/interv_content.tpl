{{*
 * $Id: interv_content.tpl 28708 2015-06-23 14:54:20Z aurelie17 $
 *
 * @package    Mediboard
 * @subpackage dPbloc
...
<td class="text">
  {{if $curr_op->exam_extempo}}
    <span class="texticon texticon-extempo" title="{{tr}}COperation-exam_extempo{{/tr}}" style="float: right;">Ext</span>
  {{/if}}
