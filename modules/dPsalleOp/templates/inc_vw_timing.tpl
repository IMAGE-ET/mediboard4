...
<form name="timing{{$selOp->operation_id}}" action="?" method="post">
  ...
  <table class="form" style="table-layout: fixed;">
    ...
    <tr>
      ...
      {{if $conf.dPsalleOp.COperation.use_installation_timings}}
        {{mb_include module=salleOp template=inc_field_timing object=$selOp field=installation_start}}
      {{/if}}
      ...
      {{if $conf.dPsalleOp.COperation.use_cleaning_timings}}
        {{mb_include module=salleOp template=inc_field_timing object=$selOp field=cleaning_start}}
      {{/if}}
    </tr>
    ...
    <tr>
      ...
      {{if $conf.dPsalleOp.COperation.use_installation_timings}}
        {{mb_include module=salleOp template=inc_field_timing object=$selOp field=installation_end}}
      {{/if}}
      ...
      {{if $conf.dPsalleOp.COperation.use_cleaning_timings}}
        {{mb_include module=salleOp template=inc_field_timing object=$selOp field=cleaning_end}}
      {{/if}}
    </tr>
  </table>
</form>