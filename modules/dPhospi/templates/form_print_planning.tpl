<!-- $Id: form_print_planning.tpl 28638 2015-06-18 09:30:48Z flaviencrochard $ -->
...
<script>
  ...
  function popPlanning() {
    ...
    var url = new Url("hospi", "print_planning");
        ...
        <table class="form">
          ...
          <tr>
            ...
            <td>
              ...
              <br />
              <input type="radio" name="select_days" onclick="changeDate('{{$next_week_deb}}','{{$next_week_fin}}');" value="nextweek" />
              <label for="select_days_nextweek">Semaine prochaine</label>
            </td>
          </tr>

          <tr>
            <th>{{mb_label object=$filter field="_date_max"}}</th>
            <td colspan="3">{{mb_field object=$filter field="_date_max" form="paramFrm" register=true canNull="false" onchange="changeDateCal(false)"}} </td>
          </tr>
          ...
          <tr>
            ...
            <td colspan="3">{{mb_field object=$filter field=_horodatage style="width: 15em;"}}</td>
          </tr>
