{{* $Id: CExamenLabo_complete.tpl 12793 2011-07-29 15:58:25Z mytto $ *}}
...
<table class="form">
  ...
  <tr>
    ...
    <td>
      ...
      &mdash; <div class="mediuser" style="display: inline; border-color: #{{$function->color}};">{{$function->_view}}</div>
