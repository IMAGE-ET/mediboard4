<?php
/**
 * $Id: CDossierMedical.class.php 28864 2015-07-06 08:57:48Z flaviencrochard $
 *
 * @package    Mediboard
 * @subpackage Patients
 * @author     SARL OpenXtrem <dev@openxtrem.com>
 * @license    GNU General Public License, see http://www.gnu.org/licenses/gpl.html
 * @version    $Revision: 28864 $
 */
    ...
    foreach ($dossier_sejour->_ref_antecedents_by_type as $_cat_name => $_cat_ante) {
      if ($_cat_name != 'alle') {
        foreach ($_cat_ante as $_key => $_ante) {
          if (isset($dossier_patient->_ref_antecedents_by_type[$_cat_name]) && is_array($dossier_patient->_ref_antecedents_by_type[$_cat_name])) {
