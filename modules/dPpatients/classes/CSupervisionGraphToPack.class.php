<?php
/**
 * $Id: CSupervisionGraphToPack.class.php 26001 2014-11-24 15:22:57Z phenxdesign $
 *
 * @package    Mediboard
 * @subpackage Patients
...
class CSupervisionGraphToPack extends CMbObject {
  ...
  function getProps() {
    ...
    $props["graph_class"] = "enum list|CSupervisionGraph|CSupervisionTimedData|CSupervisionTimedPicture|CSupervisionInstantData";
