<script>
  viewExchange = function (exchange_ftp_id) {
    var url = new Url("ftp", "ajax_view_exchange_ftp");
    url.addParam("exchange_ftp_id", exchange_ftp_id);
...
<tr>
  ...
  <td class="narrow">
    <button type="button" onclick="viewExchange('{{$object->_id}}')" class="search">
