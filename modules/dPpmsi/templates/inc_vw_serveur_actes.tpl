{{*
 * $Id: inc_vw_serveur_actes.tpl 24450 2014-08-14 12:12:37Z rhum1 $
 *
 * @package    Mediboard
 * @subpackage dPpmsi
 * @author     SARL OpenXtrem
 * @license    GNU General Public License, see http://www.gnu.org/licenses/gpl.html
 * @version    $Revision: 24450 $
 *}}
    ...
    <td>
      ...
      <table class="form">
        ...
        {{if $consult->_ref_consult_anesth->consultation_anesth_id}}
          <tr>
            <td class="button" colspan="4">Consultation de pré-anesthésie le {{$consult->_ref_plageconsult->date|date_format:"%A %d %b %Y"}}
