<?php
/**
 * $Id: COperation.class.php 28943 2015-07-10 13:21:40Z kgrisel $
 *
 * @package    Mediboard
...
class COperation extends CCodable implements IPatientRelated, IIndexableObject {
  ...
  /** @var time Cleaning start time */
  public $cleaning_start;

  /** @var time Cleaning ed time */
  public $cleaning_end;

  /** @var time Installation start time */
  public $installation_start;

  /** @var time Installation end time */
  ...
  /** @var time Cleaning time */
  public $_cleaning_time;

  /** @var time Installation time */
  ...
  function getProps() {
    ...
    // Minutage
    $props["cleaning_start"]     = "time show|0";
    $props["cleaning_end"]       = "time show|0";
    $props["installation_start"] = "time show|0";
    $props["installation_end"]   = "time show|0";
    ...
    $props['_cleaning_time']     = 'time';
    $props['_installation_time'] = 'time';
  ...
  function updateFormFields() {
    ...
    if ($this->cleaning_start && $this->cleaning_end && $this->cleaning_end > $this->cleaning_start) {
      $this->_cleaning_time = CMbDT::subTime($this->cleaning_start, $this->cleaning_end);
    }

    if ($this->installation_start && $this->installation_end && $this->installation_end > $this->installation_start) {
      $this->_installation_time = CMbDT::subTime($this->installation_start, $this->installation_end);
    }
