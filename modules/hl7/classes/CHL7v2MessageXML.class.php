<?php
/**
 * $Id: CHL7v2MessageXML.class.php 28598 2015-06-16 06:47:18Z lryo $
 * 
 * @package    Mediboard
 * @subpackage hl7
 * @author     SARL OpenXtrem <dev@openxtrem.com>
 * @license    GNU General Public License, see http://www.gnu.org/licenses/gpl.html 
 * @version    $Revision: 28598 $
 */
...
class CHL7v2MessageXML extends CMbXMLDocument {
  ...
  function getRIIdentifiers(DOMNode $node, &$data, CInteropSender $sender) {
    ...
    // Notre propre RI
    if ($this->queryTextNode("CX.4/HD.1", $node) == CAppUI::conf("hl7 assigning_authority_namespace_id") ||
