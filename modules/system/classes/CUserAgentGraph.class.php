...
/**
 * $Id: CUserAgentGraph.class.php 24475 2014-08-20 08:34:05Z kgrisel $
 *
 * @category System
 * @package  Mediboard
 * @author   SARL OpenXtrem <dev@openxtrem.com>
 * @license  GNU General Public License, see http://www.gnu.org/licenses/gpl.html
 * @version  $Revision: 24475 $
...
class CUserAgentGraph {
  ...
  static function getBrowserVersionSeries($versions) {
    ...
    foreach ($browsers as $_browser => $_version) {
      ...
      $ticks[] = array(
        "0" => $i,
        "1" => "<strong>" . utf8_encode($_browser) . "</strong>"
      );
    }
    $max = $i + 1;
