<?php
/**
 * $Id: CConsultation.class.php 28886 2015-07-07 07:48:10Z aurelie17 $
 *
 * @package    Mediboard
 * @subpackage cabinet
 * @author     SARL OpenXtrem <dev@openxtrem.com>
 * @license    GNU General Public License, see http://www.gnu.org/licenses/gpl.html
 * @version    $Revision: 28886 $
 */
...
class CConsultation extends CFacturable implements IPatientRelated, IIndexableObject {
  ...
  function getProps() {
    ...
    $props["motif_annulation"]  = "enum list|not_arrived|by_patient|other default|not_arrived";
    $props["_etat"]             = "str";
