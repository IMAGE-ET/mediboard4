{{* $Id: inc_edit_ex_field_spec2.tpl 23184 2014-05-16 09:02:10Z phenxdesign $ *}}
...
{{if $spec instanceof CEnumSpec && $context && $context->_id}}
  ...
  {{/if}}
{{elseif $spec instanceof CBoolSpec && $context && $context->_id && $context instanceof CExClassField}}
